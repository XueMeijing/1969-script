...
GitHub recognizes the commit to have been created at `12am, 1st January, 1970` and thus registers a contribution at that moment in time. If you scroll to the first year on your profile, you will see there is a single contribution to your `1969` repository, on 1st January.
